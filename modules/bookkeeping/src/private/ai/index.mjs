...
\`\`\`json
{
  ...
  "bookkeeping_input": {
    ...
    "open_item_changes": [
      { "action": "open", "item_id": "supplier:130989", "date": "YYYY-MM-DD", "kind": "supplier_payable", "party": "Exact counterparty name", "amount": "9295.00 SEK", "due_date": "YYYY-MM-DD", "evidence_document_ids": ["exact document_id"] },
      { "action": "settle", "item_id": "supplier:130989", "date": "YYYY-MM-DD", "amount": "9295.00 SEK", "evidence_document_ids": ["exact document_id"] },
      { "action": "open", "item_id": "related_party:Namn Namnsson:2026-08-03", "date": "2026-08-03", "kind": "related_party_payable", "party": "Namn Namnsson", "amount": "615.71 SEK", "evidence_document_ids": ["exact document_id"] }
    ],
