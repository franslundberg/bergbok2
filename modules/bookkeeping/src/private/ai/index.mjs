...
\`\`\`json
{
  ...
  "bookkeeping_input": {
    ...
    "open_item_changes": [
      ...
      { "action": "open", "item_id": "related_party:Namn Namnsson:2026-08-03", "kind": "related_party_payable", "party": "Namn Namnsson", "amount": "615.71 SEK", "evidence_document_ids": ["exact document_id"] }
    ],
