...
// The model may need several inspect/validate/repair cycles for a full period.
// The wall-clock, tool-output, and container limits remain independent guards.
