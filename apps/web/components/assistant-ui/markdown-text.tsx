...
const defaultComponents = memoizeMarkdownComponents({
  ...
  a: ({ className, href, ...props }) => {
    // The execute_code card is the only supported artifact download UI.
    // Hide duplicate model-generated artifact links while preserving web citations.
    if (typeof href === "string" && href.includes("/api/artifacts/")) return null;
    return (
      <a
        className={cn(
